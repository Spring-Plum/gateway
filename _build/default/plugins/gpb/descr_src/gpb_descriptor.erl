...
-spec encode_msg(#'UninterpretedOption.NamePart'{} | #'UninterpretedOption'{} | #'EnumValueOptions'{} | #'FileOptions'{} | #'EnumOptions'{} | #'EnumValueDescriptorProto'{} | #'EnumDescriptorProto'{} | #'OneofDescriptorProto'{} | #'SourceCodeInfo.Location'{} | #'ServiceOptions'{} | #'GeneratedCodeInfo.Annotation'{} | #'DescriptorProto.ExtensionRange'{} | #'DescriptorProto.ReservedRange'{} | #'MessageOptions'{} | #'FieldOptions'{} | #'FieldDescriptorProto'{} | #'DescriptorProto'{} | #'SourceCodeInfo'{} | #'MethodOptions'{} | #'MethodDescriptorProto'{} | #'ServiceDescriptorProto'{} | #'FileDescriptorProto'{} | #'FileDescriptorSet'{} | #'GeneratedCodeInfo'{}) -> binary().
encode_msg(Msg) -> encode_msg(Msg, []).


-spec encode_msg(#'UninterpretedOption.NamePart'{} | #'UninterpretedOption'{} | #'EnumValueOptions'{} | #'FileOptions'{} | #'EnumOptions'{} | #'EnumValueDescriptorProto'{} | #'EnumDescriptorProto'{} | #'OneofDescriptorProto'{} | #'SourceCodeInfo.Location'{} | #'ServiceOptions'{} | #'GeneratedCodeInfo.Annotation'{} | #'DescriptorProto.ExtensionRange'{} | #'DescriptorProto.ReservedRange'{} | #'MessageOptions'{} | #'FieldOptions'{} | #'FieldDescriptorProto'{} | #'DescriptorProto'{} | #'SourceCodeInfo'{} | #'MethodOptions'{} | #'MethodDescriptorProto'{} | #'ServiceDescriptorProto'{} | #'FileDescriptorProto'{} | #'FileDescriptorSet'{} | #'GeneratedCodeInfo'{}, list()) -> binary().
encode_msg(Msg, Opts) ->
    ...
    case Key of
	  ...
	  case Key band 7 of
		...
		'skip_length_delimited_UninterpretedOption.NamePart'(Rest,
								     ...
								     TrUserData);
	    3 ->
		'skip_group_UninterpretedOption.NamePart'(Rest,
							  Key bsr 3, 0, F1, F2,
							  TrUserData);
	    5 ->
...
'skip_group_UninterpretedOption.NamePart'(Bin, FNum, Z2,
					  F1, F2, TrUserData) ->
    ...
    case Key of
	  ...
	  case Key band 7 of
		...
		skip_length_delimited_UninterpretedOption(Rest, 0, 0,
							  ...
							  F6, F7, TrUserData);
	    3 ->
		skip_group_UninterpretedOption(Rest, Key bsr 3, 0, F1,
					       F2, F3, F4, F5, F6, F7,
					       TrUserData);
	    5 ->
...
skip_group_UninterpretedOption(Bin, FNum, Z2, F1, F2,
			       F3, F4, F5, F6, F7, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_UninterpretedOption(Rest, 0, Z2, F1,
					   F2, F3, F4, F5, F6, F7, TrUserData).
    ...
    case Key of
	  ...
	  case Key band 7 of
		...
		skip_length_delimited_EnumValueOptions(Rest, 0, 0, F1,
						       F2, TrUserData);
	    3 ->
		skip_group_EnumValueOptions(Rest, Key bsr 3, 0, F1, F2,
					    TrUserData);
	    5 ->
...
skip_group_EnumValueOptions(Bin, FNum, Z2, F1, F2,
			    TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_EnumValueOptions(Rest, 0, Z2, F1, F2,
					TrUserData).
    ...
    case Key of
	  ...
	  case Key band 7 of
		...
		skip_length_delimited_FileOptions(Rest, 0, 0, F1, F2,
						  ...
						  F16, TrUserData);
	    3 ->
		skip_group_FileOptions(Rest, Key bsr 3, 0, F1, F2, F3,
				       F4, F5, F6, F7, F8, F9, F10, F11, F12,
				       F13, F14, F15, F16, TrUserData);
	    5 ->
...
skip_group_FileOptions(Bin, FNum, Z2, F1, F2, F3, F4,
		       F5, F6, F7, F8, F9, F10, F11, F12, F13, F14, F15, F16,
		       TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_FileOptions(Rest, 0, Z2, F1, F2, F3,
				   F4, F5, F6, F7, F8, F9, F10, F11, F12, F13,
				   F14, F15, F16, TrUserData).
    ...
    case Key of
	  ...
	  case Key band 7 of
		...
		skip_length_delimited_EnumOptions(Rest, 0, 0, F1, F2,
						  F3, TrUserData);
	    3 ->
		skip_group_EnumOptions(Rest, Key bsr 3, 0, F1, F2, F3,
				       TrUserData);
	    5 ->
...
skip_group_EnumOptions(Bin, FNum, Z2, F1, F2, F3,
		       TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_EnumOptions(Rest, 0, Z2, F1, F2, F3,
				   TrUserData).
    ...
    case Key of
	  ...
	  case Key band 7 of
		...
		skip_length_delimited_EnumValueDescriptorProto(Rest, 0,
							       ...
							       TrUserData);
	    3 ->
		skip_group_EnumValueDescriptorProto(Rest, Key bsr 3, 0,
						    F1, F2, F3, TrUserData);
	    5 ->
...
skip_group_EnumValueDescriptorProto(Bin, FNum, Z2, F1,
				    F2, F3, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_EnumValueDescriptorProto(Rest, 0, Z2,
						F1, F2, F3, TrUserData).
    ...
    case Key of
	  ...
	  case Key band 7 of
		...
		skip_length_delimited_EnumDescriptorProto(Rest, 0, 0,
							  ...
							  TrUserData);
	    3 ->
		skip_group_EnumDescriptorProto(Rest, Key bsr 3, 0, F1,
					       F2, F3, TrUserData);
	    5 ->
...
skip_group_EnumDescriptorProto(Bin, FNum, Z2, F1, F2,
			       F3, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_EnumDescriptorProto(Rest, 0, Z2, F1,
					   F2, F3, TrUserData).
    ...
    case Key of
	  ...
	  case Key band 7 of
		...
		skip_length_delimited_OneofDescriptorProto(Rest, 0, 0,
							   F1, TrUserData);
	    3 ->
		skip_group_OneofDescriptorProto(Rest, Key bsr 3, 0, F1,
						TrUserData);
	    5 ->
...
skip_group_OneofDescriptorProto(Bin, FNum, Z2, F1,
				TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_OneofDescriptorProto(Rest, 0, Z2, F1,
					    TrUserData).
...
'dg_read_field_def_SourceCodeInfo.Location'(<<0:1, X:7,
    ...
    case Key of
      10 ->
	  'd_pfield_SourceCodeInfo.Location_path'(Rest, 0, 0, F1,
						  F2, F3, F4, F5, TrUserData);
      8 ->
	  'd_field_SourceCodeInfo.Location_path'(Rest, 0, 0, F1,
						 F2, F3, F4, F5, TrUserData);
      18 ->
	  'd_pfield_SourceCodeInfo.Location_span'(Rest, 0, 0, F1,
						  F2, F3, F4, F5, TrUserData);
      16 ->
...
'd_field_SourceCodeInfo.Location_path'(<<0:1, X:7,
    ...
    <<NewFValue:32/signed-native>> = <<(X bsl N +
					  Acc):32/unsigned-native>>,
    'dfp_read_field_def_SourceCodeInfo.Location'(Rest, 0, 0,
						 cons(NewFValue, F1,
						      TrUserData),
						 F2, F3, F4, F5, TrUserData).
...
'skip_group_SourceCodeInfo.Location'(Bin, FNum, Z2, F1,
				     F2, F3, F4, F5, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    ...
    case Key of
	  ...
	  case Key band 7 of
		...
		skip_length_delimited_ServiceOptions(Rest, 0, 0, F1, F2,
						     TrUserData);
	    3 ->
		skip_group_ServiceOptions(Rest, Key bsr 3, 0, F1, F2,
					  TrUserData);
	    5 ->
...
skip_group_ServiceOptions(Bin, FNum, Z2, F1, F2,
			  TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_ServiceOptions(Rest, 0, Z2, F1, F2,
				      TrUserData).
...
'dfp_read_field_def_GeneratedCodeInfo.Annotation'(<<10,
						  ...
						  Z1, Z2, F1, F2, F3, F4,
						  TrUserData) ->
    'd_pfield_GeneratedCodeInfo.Annotation_path'(Rest, Z1,
						 Z2, F1, F2, F3, F4,
						 TrUserData);
'dfp_read_field_def_GeneratedCodeInfo.Annotation'(<<8,
						    Rest/binary>>,
						  Z1, Z2, F1, F2, F3, F4,
						  TrUserData) ->
...
'dg_read_field_def_GeneratedCodeInfo.Annotation'(<<0:1,
    ...
    case Key of
      10 ->
	  'd_pfield_GeneratedCodeInfo.Annotation_path'(Rest, 0, 0,
						       F1, F2, F3, F4,
						       TrUserData);
      8 ->
	  ...
	  case Key band 7 of
		...
		'skip_length_delimited_GeneratedCodeInfo.Annotation'(Rest,
								     ...
								     TrUserData);
	    3 ->
		'skip_group_GeneratedCodeInfo.Annotation'(Rest,
							  Key bsr 3, 0, F1, F2,
							  F3, F4, TrUserData);
	    5 ->
...
'd_pfield_GeneratedCodeInfo.Annotation_path'(<<1:1, X:7,
					       Rest/binary>>,
					     N, Acc, F1, F2, F3, F4, TrUserData)
    when N < 57 ->
    'd_pfield_GeneratedCodeInfo.Annotation_path'(Rest,
						 N + 7, X bsl N + Acc, F1, F2,
						 F3, F4, TrUserData);
'd_pfield_GeneratedCodeInfo.Annotation_path'(<<0:1, X:7,
					       Rest/binary>>,
					     N, Acc, F1, F2, F3, F4,
					     TrUserData) ->
    Len = X bsl N + Acc,
...
'skip_group_GeneratedCodeInfo.Annotation'(Bin, FNum, Z2,
					  F1, F2, F3, F4, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    'dfp_read_field_def_GeneratedCodeInfo.Annotation'(Rest,
						      0, Z2, F1, F2, F3, F4,
    ...
    case Key of
	  ...
	  case Key band 7 of
		...
		'skip_length_delimited_DescriptorProto.ExtensionRange'(Rest,
								       ...
								       TrUserData);
	    3 ->
		'skip_group_DescriptorProto.ExtensionRange'(Rest,
							    Key bsr 3, 0, F1,
							    F2, TrUserData);
	    5 ->
...
'skip_group_DescriptorProto.ExtensionRange'(Bin, FNum,
					    Z2, F1, F2, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    'dfp_read_field_def_DescriptorProto.ExtensionRange'(Rest,
							0, Z2, F1, F2,
    ...
    case Key of
	  ...
	  case Key band 7 of
		...
		'skip_length_delimited_DescriptorProto.ReservedRange'(Rest,
								      ...
								      TrUserData);
	    3 ->
		'skip_group_DescriptorProto.ReservedRange'(Rest,
							   Key bsr 3, 0, F1, F2,
							   TrUserData);
	    5 ->
...
'skip_group_DescriptorProto.ReservedRange'(Bin, FNum,
					   Z2, F1, F2, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    'dfp_read_field_def_DescriptorProto.ReservedRange'(Rest,
						       0, Z2, F1, F2,
    ...
    case Key of
	  ...
	  case Key band 7 of
		...
		skip_length_delimited_MessageOptions(Rest, 0, 0, F1, F2,
						     F3, F4, F5, TrUserData);
	    3 ->
		skip_group_MessageOptions(Rest, Key bsr 3, 0, F1, F2,
					  F3, F4, F5, TrUserData);
	    5 ->
...
skip_group_MessageOptions(Bin, FNum, Z2, F1, F2, F3, F4,
			  F5, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_MessageOptions(Rest, 0, Z2, F1, F2,
				      F3, F4, F5, TrUserData).
    ...
    case Key of
	  ...
	  case Key band 7 of
		...
		skip_length_delimited_FieldOptions(Rest, 0, 0, F1, F2,
						   ...
						   TrUserData);
	    3 ->
		skip_group_FieldOptions(Rest, Key bsr 3, 0, F1, F2, F3,
					F4, F5, F6, F7, TrUserData);
	    5 ->
...
skip_group_FieldOptions(Bin, FNum, Z2, F1, F2, F3, F4,
			F5, F6, F7, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_FieldOptions(Rest, 0, Z2, F1, F2, F3,
				    F4, F5, F6, F7, TrUserData).
    ...
    case Key of
	  ...
	  case Key band 7 of
		...
		skip_length_delimited_FieldDescriptorProto(Rest, 0, 0,
							   ...
							   TrUserData);
	    3 ->
		skip_group_FieldDescriptorProto(Rest, Key bsr 3, 0, F1,
						F2, F3, F4, F5, F6, F7, F8, F9,
						F10, TrUserData);
	    5 ->
...
skip_group_FieldDescriptorProto(Bin, FNum, Z2, F1, F2,
				F3, F4, F5, F6, F7, F8, F9, F10, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_FieldDescriptorProto(Rest, 0, Z2, F1,
					    F2, F3, F4, F5, F6, F7, F8, F9, F10,
					    TrUserData).
    ...
    case Key of
	  ...
	  case Key band 7 of
		...
		skip_length_delimited_DescriptorProto(Rest, 0, 0, F1,
						      ...
						      F8, F9, F10, TrUserData);
	    3 ->
		skip_group_DescriptorProto(Rest, Key bsr 3, 0, F1, F2,
					   F3, F4, F5, F6, F7, F8, F9, F10,
					   TrUserData);
	    5 ->
...
skip_group_DescriptorProto(Bin, FNum, Z2, F1, F2, F3,
			   F4, F5, F6, F7, F8, F9, F10, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_DescriptorProto(Rest, 0, Z2, F1, F2,
				       F3, F4, F5, F6, F7, F8, F9, F10,
				       TrUserData).
    ...
    case Key of
	  ...
	  case Key band 7 of
		...
		skip_length_delimited_SourceCodeInfo(Rest, 0, 0, F1,
						     TrUserData);
	    3 ->
		skip_group_SourceCodeInfo(Rest, Key bsr 3, 0, F1,
					  TrUserData);
...
skip_group_SourceCodeInfo(Bin, FNum, Z2, F1,
			  TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_SourceCodeInfo(Rest, 0, Z2, F1,
				      TrUserData).
    ...
    case Key of
	  ...
	  case Key band 7 of
		...
		skip_length_delimited_MethodOptions(Rest, 0, 0, F1, F2,
						    TrUserData);
	    3 ->
		skip_group_MethodOptions(Rest, Key bsr 3, 0, F1, F2,
					 TrUserData);
	    5 ->
...
skip_group_MethodOptions(Bin, FNum, Z2, F1, F2,
			 TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_MethodOptions(Rest, 0, Z2, F1, F2,
				     TrUserData).
    ...
    case Key of
	  ...
	  case Key band 7 of
		...
		skip_length_delimited_MethodDescriptorProto(Rest, 0, 0,
							    ...
							    F6, TrUserData);
	    3 ->
		skip_group_MethodDescriptorProto(Rest, Key bsr 3, 0, F1,
						 F2, F3, F4, F5, F6,
						 TrUserData);
	    5 ->
...
skip_group_MethodDescriptorProto(Bin, FNum, Z2, F1, F2,
				 F3, F4, F5, F6, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_MethodDescriptorProto(Rest, 0, Z2,
					     F1, F2, F3, F4, F5, F6,
					     TrUserData).
    ...
    case Key of
	  ...
	  case Key band 7 of
		...
		skip_length_delimited_ServiceDescriptorProto(Rest, 0, 0,
							     ...
							     TrUserData);
	    3 ->
		skip_group_ServiceDescriptorProto(Rest, Key bsr 3, 0,
						  F1, F2, F3, TrUserData);
	    5 ->
...
skip_group_ServiceDescriptorProto(Bin, FNum, Z2, F1, F2,
				  F3, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_ServiceDescriptorProto(Rest, 0, Z2,
					      F1, F2, F3, TrUserData).
...
dfp_read_field_def_FileDescriptorProto(<<26,
    ...
    d_field_FileDescriptorProto_dependency(Rest, Z1, Z2, F1,
					   F2, F3, F4, F5, F6, F7, F8, F9, F10,
					   F11, F12, TrUserData);
dfp_read_field_def_FileDescriptorProto(<<82,
					 Rest/binary>>,
				       Z1, Z2, F1, F2, F3, F4, F5, F6, F7, F8,
				       F9, F10, F11, F12, TrUserData) ->
    d_pfield_FileDescriptorProto_public_dependency(Rest, Z1,
						   Z2, F1, F2, F3, F4, F5, F6,
						   F7, F8, F9, F10, F11, F12,
						   TrUserData);
dfp_read_field_def_FileDescriptorProto(<<80,
    ...
    d_field_FileDescriptorProto_public_dependency(Rest, Z1,
						  ...
						  F7, F8, F9, F10, F11, F12,
						  TrUserData);
dfp_read_field_def_FileDescriptorProto(<<90,
					 Rest/binary>>,
				       Z1, Z2, F1, F2, F3, F4, F5, F6, F7, F8,
				       F9, F10, F11, F12, TrUserData) ->
    d_pfield_FileDescriptorProto_weak_dependency(Rest, Z1,
						 Z2, F1, F2, F3, F4, F5, F6, F7,
						 F8, F9, F10, F11, F12,
						 TrUserData);
...
dg_read_field_def_FileDescriptorProto(<<0:1, X:7,
    ...
    case Key of
	  ...
	  d_field_FileDescriptorProto_dependency(Rest, 0, 0, F1,
						 ...
						 F10, F11, F12, TrUserData);
      82 ->
	  d_pfield_FileDescriptorProto_public_dependency(Rest, 0,
							 0, F1, F2, F3, F4, F5,
							 F6, F7, F8, F9, F10,
							 F11, F12, TrUserData);
      80 ->
	  d_field_FileDescriptorProto_public_dependency(Rest, 0,
							...
							F11, F12, TrUserData);
      90 ->
	  d_pfield_FileDescriptorProto_weak_dependency(Rest, 0, 0,
						       F1, F2, F3, F4, F5, F6,
						       F7, F8, F9, F10, F11,
						       F12, TrUserData);
      88 ->
	  ...
	  case Key band 7 of
		...
		skip_length_delimited_FileDescriptorProto(Rest, 0, 0,
							  ...
							  F11, F12, TrUserData);
	    3 ->
		skip_group_FileDescriptorProto(Rest, Key bsr 3, 0, F1,
					       F2, F3, F4, F5, F6, F7, F8, F9,
					       F10, F11, F12, TrUserData);
	    5 ->
...
d_pfield_FileDescriptorProto_public_dependency(<<1:1,
						 X:7, Rest/binary>>,
					       N, Acc, F1, F2, F3, F4, F5, F6,
					       F7, F8, F9, F10, F11, F12,
					       TrUserData)
    when N < 57 ->
    d_pfield_FileDescriptorProto_public_dependency(Rest,
						   N + 7, X bsl N + Acc, F1, F2,
						   F3, F4, F5, F6, F7, F8, F9,
						   F10, F11, F12, TrUserData);
d_pfield_FileDescriptorProto_public_dependency(<<0:1,
						 X:7, Rest/binary>>,
					       N, Acc, F1, F2, F3, F4, F5, F6,
					       F7, F8, F9, F10, F11, F12,
					       TrUserData) ->
    ...
    <<PackedBytes:Len/binary, Rest2/binary>> = Rest,
    NewSeq =
	d_packed_field_FileDescriptorProto_public_dependency(PackedBytes,
							     0, 0, F4),
    dfp_read_field_def_FileDescriptorProto(Rest2, 0, 0, F1,
					   F2, F3, NewSeq, F5, F6, F7, F8, F9,
					   F10, F11, F12, TrUserData).


d_packed_field_FileDescriptorProto_public_dependency(<<1:1,
						       X:7, Rest/binary>>,
						     N, Acc, AccSeq)
    when N < 57 ->
    d_packed_field_FileDescriptorProto_public_dependency(Rest,
							 N + 7, X bsl N + Acc,
							 AccSeq);
d_packed_field_FileDescriptorProto_public_dependency(<<0:1,
						       X:7, Rest/binary>>,
						     N, Acc, AccSeq) ->
    <<NewFValue:32/signed-native>> = <<(X bsl N +
					  Acc):32/unsigned-native>>,
    d_packed_field_FileDescriptorProto_public_dependency(Rest,
							 0, 0,
							 [NewFValue | AccSeq]);
d_packed_field_FileDescriptorProto_public_dependency(<<>>,
						     0, 0, AccSeq) ->
    AccSeq.
...
d_pfield_FileDescriptorProto_weak_dependency(<<1:1, X:7,
					       Rest/binary>>,
					     N, Acc, F1, F2, F3, F4, F5, F6, F7,
					     F8, F9, F10, F11, F12, TrUserData)
    when N < 57 ->
    d_pfield_FileDescriptorProto_weak_dependency(Rest,
						 N + 7, X bsl N + Acc, F1, F2,
						 F3, F4, F5, F6, F7, F8, F9,
						 F10, F11, F12, TrUserData);
d_pfield_FileDescriptorProto_weak_dependency(<<0:1, X:7,
					       Rest/binary>>,
					     N, Acc, F1, F2, F3, F4, F5, F6, F7,
					     F8, F9, F10, F11, F12,
					     TrUserData) ->
    ...
    <<PackedBytes:Len/binary, Rest2/binary>> = Rest,
    NewSeq =
	d_packed_field_FileDescriptorProto_weak_dependency(PackedBytes,
							   0, 0, F5),
    dfp_read_field_def_FileDescriptorProto(Rest2, 0, 0, F1,
					   F2, F3, F4, NewSeq, F6, F7, F8, F9,
					   F10, F11, F12, TrUserData).


d_packed_field_FileDescriptorProto_weak_dependency(<<1:1,
						     X:7, Rest/binary>>,
						   N, Acc, AccSeq)
    when N < 57 ->
    d_packed_field_FileDescriptorProto_weak_dependency(Rest,
						       N + 7, X bsl N + Acc,
						       AccSeq);
d_packed_field_FileDescriptorProto_weak_dependency(<<0:1,
						     X:7, Rest/binary>>,
						   N, Acc, AccSeq) ->
    <<NewFValue:32/signed-native>> = <<(X bsl N +
					  Acc):32/unsigned-native>>,
    d_packed_field_FileDescriptorProto_weak_dependency(Rest,
						       0, 0,
						       [NewFValue | AccSeq]);
d_packed_field_FileDescriptorProto_weak_dependency(<<>>,
						   0, 0, AccSeq) ->
    AccSeq.
...
skip_group_FileDescriptorProto(Bin, FNum, Z2, F1, F2,
			       F3, F4, F5, F6, F7, F8, F9, F10, F11, F12,
			       TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_FileDescriptorProto(Rest, 0, Z2, F1,
					   F2, F3, F4, F5, F6, F7, F8, F9, F10,
					   F11, F12, TrUserData).
    ...
    case Key of
	  ...
	  case Key band 7 of
		...
		skip_length_delimited_FileDescriptorSet(Rest, 0, 0, F1,
							TrUserData);
	    3 ->
		skip_group_FileDescriptorSet(Rest, Key bsr 3, 0, F1,
					     TrUserData);
	    5 ->
...
skip_group_FileDescriptorSet(Bin, FNum, Z2, F1,
			     TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_FileDescriptorSet(Rest, 0, Z2, F1,
					 TrUserData).
    ...
    case Key of
	  ...
	  case Key band 7 of
		...
		skip_length_delimited_GeneratedCodeInfo(Rest, 0, 0, F1,
							TrUserData);
	    3 ->
		skip_group_GeneratedCodeInfo(Rest, Key bsr 3, 0, F1,
					     TrUserData);
	    5 ->
...
skip_group_GeneratedCodeInfo(Bin, FNum, Z2, F1,
			     TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_GeneratedCodeInfo(Rest, 0, Z2, F1,
					 TrUserData).
...
'merge_msg_SourceCodeInfo.Location'(#'SourceCodeInfo.Location'{path
    ...
    #'SourceCodeInfo.Location'{path =
			       ...
			       leading_detached_comments =
				   if PFleading_detached_comments /= undefined,
				      NFleading_detached_comments /=
					undefined ->
...
merge_msg_DescriptorProto(#'DescriptorProto'{name =
    ...
    #'DescriptorProto'{name =
			   ...
			   if PFfield /= undefined, NFfield /= undefined ->
				  'erlang_++'(PFfield, NFfield, TrUserData);
			   ...
			   if PFoneof_decl /= undefined,
				  ...
				  'erlang_++'(PFoneof_decl, NFoneof_decl,
					      TrUserData);
...
merge_msg_FileDescriptorProto(#'FileDescriptorProto'{name
    ...
    #'FileDescriptorProto'{name =
			   ...
			   public_dependency =
			       if PFpublic_dependency /= undefined,
				  NFpublic_dependency /= undefined ->
				      'erlang_++'(PFpublic_dependency,
						  NFpublic_dependency,
						  TrUserData);
				  PFpublic_dependency == undefined ->
				      NFpublic_dependency;
				  NFpublic_dependency == undefined ->
				      PFpublic_dependency
			       end,
			   weak_dependency =
			       if PFweak_dependency /= undefined,
				  NFweak_dependency /= undefined ->
				      'erlang_++'(PFweak_dependency,
						  NFweak_dependency,
						  TrUserData);
				  PFweak_dependency == undefined ->
				      NFweak_dependency;
				  NFweak_dependency == undefined ->
				      PFweak_dependency
			       end,
...
get_msg_names() ->
    ['UninterpretedOption.NamePart', 'UninterpretedOption',
     'EnumValueOptions', 'FileOptions', 'EnumOptions',
     'EnumValueDescriptorProto', 'EnumDescriptorProto',
     'OneofDescriptorProto', 'SourceCodeInfo.Location',
     'ServiceOptions', 'GeneratedCodeInfo.Annotation',
     'DescriptorProto.ExtensionRange',
     'DescriptorProto.ReservedRange', 'MessageOptions',
     'FieldOptions', 'FieldDescriptorProto',
     'DescriptorProto', 'SourceCodeInfo', 'MethodOptions',
