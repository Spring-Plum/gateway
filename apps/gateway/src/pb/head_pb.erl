...
-export([enum_symbol_by_value_msg_type/1, enum_value_by_symbol_msg_type/1]).
...
get_msg_defs() -> [{{enum, msg_type}, [{'Login', 0}]}].
...
find_enum_def(msg_type) -> [{'Login', 0}];
find_enum_def(_) -> error.


enum_symbol_by_value(msg_type, Value) ->
    enum_symbol_by_value_msg_type(Value).


enum_value_by_symbol(msg_type, Sym) ->
    enum_value_by_symbol_msg_type(Sym).


enum_symbol_by_value_msg_type(0) -> 'Login'.


enum_value_by_symbol_msg_type('Login') -> 0.
