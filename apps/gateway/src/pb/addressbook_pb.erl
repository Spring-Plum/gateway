...
-spec encode_msg(#person{}, list()) -> binary().
encode_msg(Msg, Opts) ->
    ...
    case Key of
	  ...
	  case Key band 7 of
		...
		skip_length_delimited_person(Rest, 0, 0, F1, F2, F3,
					     TrUserData);
	    3 ->
		skip_group_person(Rest, Key bsr 3, 0, F1, F2, F3,
				  TrUserData);
...
skip_group_person(Bin, FNum, Z2, F1, F2, F3,
		  TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_person(Rest, 0, Z2, F1, F2, F3,
			      TrUserData).
